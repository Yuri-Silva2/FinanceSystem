...
public enum Icon {
    ADD, ADD_BLUE, AIRPLANE, APPAREL, ARROW, ARROW_CIRCLE_DOWN, ARROW_CIRCLE_UP, BABY, BANK, BEACH, BED, BIKE, BITCOIN, BOOK,
    CAKE, CALCULATE, CAMERA, CAR, CASH, CHAT, CHURCH, CLOSE, CLOSE_FORM, CLOUD, COFFEE, CREDIT_CARD, CRIB, DENTIST, DESKTOP,
    DIRECTIONS_BUS, DOCTOR, ECG_HEART, EXPAND_MORE, FAMILY, FINANCE, FLAG, FOREST, GAMES, GAS_STATION, GYM, HANDBAG,
    HEART, HOUSE, KEY, LIGHTBULB, LIGHTING, LIST_ALT, LOCK, MAIL, MAIL_FORM, MEDICAL, MENU, MENU_BOOK, MIC, MONITORING, MORE_HORIZ,
